...
namespace isRock.Template
{
    public class LineBotChatGPTWebHookController : isRock.LineBot.LineWebHookControllerBase
    {
        ...
        {
            const string AdminUserId = "👉repleace_it_with_your_Admin_User_Id"; //👉repleace it with your Admin User Id

            try
            {
                //設定ChannelAccessToken
                this.ChannelAccessToken = "👉repleace_it_with_your_Channel_Access_Token"; //👉repleace it with your Channel Access Token
                //配合Line Verify
