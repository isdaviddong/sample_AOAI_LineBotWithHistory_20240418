...
namespace isRock.Template
{
    ...
    {
        const string AzureOpenAIEndpoint = "https://👉_____.openai.azure.com";  //👉replace it with your Azure OpenAI Endpoint
        const string AzureOpenAIModelName = "gpt3516k"; //👉repleace it with your Azure OpenAI Model Name
        const string AzureOpenAIToken = "👉_______"; //👉repleace it with your Azure OpenAI Token
